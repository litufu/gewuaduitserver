...
class ChronologicalAccount(Base):
    ...
    debit = Column(Float(20,4))
    credit = Column(Float(20,4))
    debit_foreign_currency = Column(Float(20,4))
    credit_foreign_currency = Column(Float(20,4))
    debit_number = Column(Float(20,4))
    credit_number = Column(Float(20,4))
    debit_price = Column(Float(20,4))
    credit_price = Column(Float(20,4))
