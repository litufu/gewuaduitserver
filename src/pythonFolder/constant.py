...
judge_entry_events = [
    ...
    {'no': 95, 'subject': '其他货币资金', 'judge': [{'logic': 'and', 'condition': [{'subject_direction': '借方'}], 'event': '其他货币资金增加'}, {'logic': 'and', 'condition': [{'subject_direction': '贷方'}], 'event': '其他货币资金减少'},{'logic': 'and', 'condition': [{'subject_direction': '双向'}], 'event': '其他货币资金间转账'}]}]
